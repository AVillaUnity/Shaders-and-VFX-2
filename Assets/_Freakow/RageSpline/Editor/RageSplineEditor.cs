...
public class RageSplineEditor : Editor {
    ...
    public void OnSceneGUI() {
        ...
        {
            EditorSelectedRenderState selectedRenderState = RageSpline.showWireFrameInEditor ? EditorSelectedRenderState.Wireframe : EditorSelectedRenderState.Hidden ;
            EditorUtility.SetSelectedRenderState(rageSpline.GetComponent<Renderer>(), selectedRenderState );
        }
